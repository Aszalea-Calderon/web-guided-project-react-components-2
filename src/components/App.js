...
/* import * as friends from "../dummy-data/friends"*/
  ...
  function changeStatus(id) {
    setMyFriends(
      myFriends.map((friend) => {
        // //ForEach friend, if the friend has the given id,
        // if (friend.id === id) {
        //   //return a copy of the friend object which has the toggled civil status
        //   return { ...friend, married: !friend.married }; //We are changing it to not
        // }
        // //Otherwise retun the friend unchanged.
        // return friend;
